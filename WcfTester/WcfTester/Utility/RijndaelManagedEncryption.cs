...
namespace WcfTester.Utility
{
    public class RijndaelManagedEncryption
    {
        ...
        /// </summary>
        internal const string Inputkey = "=={aG4093hHLLMmm458==854MLLHh3904a}==";
        internal const string SaltKey = "s{ew3=--34AccaEDk3De40sks£2}sSed3341ld";
        #endregion
