...
namespace BusinessTest.Generation.StarSystem
{
    ...
    public class PlanetPropertiesTest
    {
        ...
        public void TestCalculateSpaces()
        {
            ...
            Spaces x = PlanetProperties.CalculateSpaces(100, 6, new PlanetCustomConditions(), true, true, rnd);
            ...
            x = PlanetProperties.CalculateSpaces(100, 8, new PlanetCustomConditions(), false, false, rnd);
